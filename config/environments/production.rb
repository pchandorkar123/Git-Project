Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "Local-worker_#{Rails.env}"
  ...
  #host = 'localhost:3000'
  config.action_mailer.default_url_options = {host: 'new-dummy-project.herokuapp.com', :protocol => 'https'}
